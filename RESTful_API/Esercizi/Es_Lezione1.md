...
Qual è il codice di stato HTTP della risposta?
Qual è il Content-Type dell'header di risposta?
La latitudine restituita (45.0625) è diversa da quella richiesta (45.07). Perché secondo te?
Cosa contiene il campo current_units? A cosa serve averlo nella risposta?
...
Aprire Postman → nuova richiesta GET

Incollare nell'URL:

https://api.open-meteo.com/v1/forecast
Andare nel tab Params e aggiungere i parametri come coppie chiave-valore:
