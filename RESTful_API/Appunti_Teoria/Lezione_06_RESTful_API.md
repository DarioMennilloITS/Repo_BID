...
>  **Attenzione** — Usa sempre una whitelist dei campi ordinabili. Permettere l'ordinamento su un campo arbitrario passato dal client può esporre problemi di performance o, con un database SQL, aprire vulnerabilità. Non passare mai `req.query.sort` direttamente a una query.
